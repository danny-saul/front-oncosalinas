...
function guardar_cita() {
    $("#guardar-cita").click(function () {
      ...
      let fechaFormateada = new Date();
        ...
        let fecha = anio + '-' + (mes < 10 ? '0' : '') + mes + '-' + (dia < 10 ? '0' : '') + dia;


      let total_parcial = 15;
  ...
  function guardarUsuario() {
    $('#nuevo-usuario').submit(function (e) {
        ...
        let tipo_cobertura_id = 5;
        let tipo_seguro_id = 16;
        ...
        let def1 = (imagen_cedula == undefined) ? 'cedula.png' : imagen_cedula.name; 
...
function guardandousuario(json) {
    peticionJWT({
     ...
     if (json.usuario.imagen == 'userdefault.png') {
      ...
      if (json.usuario.imagen_cedula == 'cedula.png') {
