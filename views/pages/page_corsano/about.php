            ...
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index">Inicio <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Acerca de mi <i
                                class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Quien soy</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row d-flex no-gutters">
                <div class="col-md-6 d-flex order-md-last">
                    <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center mb-4 mb-sm-0"
                        style="background-image:url(<?= BASE ?>views/dist/pagina_web_corsano/images/about.jpg);">
                ...
                <div class="col-md-6 pr-md-5 py-md-5">
                    <div class="row justify-content-start py-5">
                        <div class="col-md-12 heading-section ftco-animate">
                            <span class="subheading">Bienvenidos a Corsano</span>
                            <h2 class="mb-4">Dr. Jose Adames</h2>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there
                        ...
                        a large language ocean.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos dignissimos
                        magni tempora adipisci aliquam labore, consequuntur tenetur alias fugiat reiciendis eius omnis
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(<?= BASE ?>views/dist/pagina_web_corsano/images/person_1.jpg)"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(<?= BASE ?>views/dist/pagina_web_corsano/images/person_2.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(<?= BASE ?>views/dist/pagina_web_corsano/images/person_3.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
