                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                    ...
                                                                    minlength="7" id="nuevo-telefono" value="04-0000000">
                                                            </div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                    ...
                                                                    maxlength="150" minlength="4" id="new-usuario" value=" "
                                                                    name="nombres">
                                                            </div> 
                                                        </div>
                                                        <div class="form-group row">
...
<!-- 
 ...
 -->
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" 
                                                                    class="form-control form-control-sm   d-none  danger" value="default"
                                                         ...
                                                         <div class="form-group row d-none">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control form-control-sm  d-none " value="default"
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select class="form-control form-control-sm"
                                                                    id="nuevo-operadora" disabled required>
...
<script src="<?=BASE?>views/dist/js/scripts/registrar_paciente.js?ver=1.1.1.2"> </script>
