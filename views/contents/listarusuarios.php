    ...
    <div class="card">
            <div class="card-header card-dark d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2">
                    <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Usuarios
                            </a></li>
...
<script src="<?=BASE?>views/dist/js/scripts/listarusuarios.js?ver=1.1.1.2"></script>
