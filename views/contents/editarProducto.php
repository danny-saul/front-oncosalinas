                        ...
                        <div id="accordion">
                            <div class="card card-primary">
                                ...
                                <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                    <div class="card-body">
                                        <form class="form-horizontal" id="nuevo-producto-ed" enctype="multipart/form-data">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="codigo" class="col-sm-4 col-form-label">Codigo
                                                                Producto</label>
                                                            <div class="col-sm-8">
                                                                <input type="hidden" name="" id="id-Producto">
                                                                <!-- <input type="hidden" name="" id="editar-categoria">
 -->
                                                                <input type="text" class="form-control form-control-sm"
                                                                    placeholder="0000F052555" maxlength="15"
                                                                    minlength="3" id="editar-nuevo-codigo" name="codigo"
                                                                    required>

                                                            </div>

                                                            <label class="col-sm-4 col-form-label">Categoria</label>
                                                            <!--  <input type="hidden" id="id-categoria" name="" > -->
                                                            <div class="col-sm-8">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                    ...
                                                                    id="editar-registro-Producto" name="nombres"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <textarea class="form-control form-control-sm " rows="3"
                                                                    ...
                                                                    id="editar-descripcion-Producto"></textarea>
                                                            </div>

                                                            <label class="col-sm-4 col-form-label">Presentacion</label>
                                                            <div class="col-sm-8">
                                                                <select class="form-control form-control-sm"
                                                                    id="editar-presentacion">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                    ...
                                                                    maxlength="150" minlength="4"
                                                                    id="editar-new-usuario" value=" " name="nombres">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="date"
                                                                    ...
                                                                    id="editar-nuevo-fecha" name="fecha" required>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="9.00" id="precioCompra-editar"
                                                                    >
                                                            </div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                    class="form-control form-control-sm "
                                                                    placeholder="10.50" id="precioVenta-editar"
                                                                    >
                                                            </div>
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="custom-file">
                                                                        <input type="file" name="img"
                                                                            id="e-imagen-Producto"
                                                                            class="custom-file-input"
                                                                            accept=".jpg, .jpeg">
                                                                        <label class="custom-file-label"
                                                                            for="e-imagen-Producto">Subir
                                                                            Archivo</label>
                                                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12" style="width: 218px; height: 315px">
                                <img id="imagen-produc-e" src="<?=SERVIDOR?>resources/usuarios/default.jpg"
