                    ...
                    <ul class="nav nav-pills ml-auto p-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#tab_1" data-toggle="tab">
                                <i class="fas fa-file-medical"></i> Amanesis
                            </a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="motivo-consulta" rows="5"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" id="enfermedad-actual"
                                                    placeholder="Enter ..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" id="antecedentes"
                                                    placeholder="Enter ..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" id="alergias"
                                                    placeholder="Enter ..."></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" id="evolucion"
                                                    placeholder="Enter ..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label>Orden Imagen/Laboratorio</label>
                                                            ...
                                                            <div class="col-md-1">
                                                                ...
                                                                <select type="text" class="form-control form-control-sm"
                                                                    id="lateralidad">
                                                                    <option value="0">Seleccione lateralidad
                                                                    </option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p>Edad: <span id="resumen-edad"></span> </p>
                                            <p>Fecha Nacimiento: <span id="resumen-fechanac"></span> </p>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control form-control-sm"
                                                                ...
                                                                <option value="16">Seleccione el Tipo de Contingencia
                                                                </option>
                                                        ...
                                                        <label for="cedula" class="col-sm-4 col-form-label">Dia de
                                                            Descanso</label>
                                                        <div class="col-sm-8">
                                                            <input type="text"
                                                                class="form-control form-control-sm  solo-numeros"
                                                        ...
                                                        <label class="col-sm-4 col-form-label">Actividad Laboral</label>
                                                        <div class="col-sm-8">
                                                            <input type="text"
                                                        ...
                                                        <label for="persona-nombres"
                                                            class="col-sm-4 col-form-label">Entidad de Trabajo</label>
                                                        <div class="col-sm-8">
                                                            <input type="text"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <label for="persona-nombres"
                                                            class="col-sm-4 col-form-label">Aislamiento</label>
                                                        <div class="col-sm-8">
                                                            <select class="form-control form-control-sm"
...
<script src="<?=BASE?>views/plugins/jquery/odo/knockout-2.0.0.js"></script>
...
<script src="<?=BASE?>views/dist/js/scripts/odontograma.js?ver=1.1.1.3"></script>
<script src="<?=BASE?>views/dist/js/scripts/atenderCitas.js?ver=1.1.1.10"></script>
